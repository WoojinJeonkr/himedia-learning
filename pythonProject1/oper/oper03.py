...
#   처리 내용
# 조건 1,2,3 모두 만족하면
# 조건 1이 False이면 조건 2,3을 체크할 필요없음
# 조건 1에 False일 가능성이 제일 큰 것을 넣음
...
if save_id == data_id and save_pw == data_pw :
    print('login 성공')
...
#   처리 내용
# 조건 1,2,3 중 하나라도 만족하면
# 조건 1이 True이면 조건 2,3을 체크할 필요없음
# 조건 1에 True일 가능성이 제일 큰 것을 넣음
